...
class ECGNet(nn.Module):
    def __init__(self, input_channel=1, num_classes=3):  # , layers=[2, 2, 2, 2, 2, 2]
        sizes = [
            [3, 3, 3, 3, 3, 3],
            [5, 5, 5, 5, 3, 3],
            [7, 7, 7, 7, 3, 3],
        ...
        # self.drop = nn.Dropout(p=0.2)
        self.fc = nn.Linear(256 * len(sizes), num_classes)
        self.sig = nn.Sigmoid()
